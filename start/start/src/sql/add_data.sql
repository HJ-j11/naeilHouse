...
INSERT INTO ORDERS  (ORDER_ID, ORDER_DATE , CONSUMER_ID, ORDER_STATUS,  DELIVERY_ID) VALUES (1, '20221010', 1, 1,1);
INSERT INTO ORDERS  (ORDER_ID, ORDER_DATE , CONSUMER_ID, ORDER_STATUS,  DELIVERY_ID) VALUES (2, '20221011', 1, 0,2);
INSERT INTO ORDERS  (ORDER_ID, ORDER_DATE , CONSUMER_ID, ORDER_STATUS,  DELIVERY_ID) VALUES (3, '20221012', 1, 3,3);
...
INSERT INTO ORDER_ITEM  (ORDERITEM_ID,COUNT ,ORDER_PRICE ,ITEM_ID ,ORDER_ID,REVIEW_YN   ) VALUES (1, 1, 1000, 1, 1,false);
INSERT INTO ORDER_ITEM  (ORDERITEM_ID,COUNT ,ORDER_PRICE ,ITEM_ID ,ORDER_ID ,REVIEW_YN  ) VALUES (2, 1, 1000, 1, 1,false);
INSERT INTO ORDER_ITEM  (ORDERITEM_ID,COUNT ,ORDER_PRICE ,ITEM_ID ,ORDER_ID ,REVIEW_YN  ) VALUES (3, 1, 1000, 2, 2,false);
INSERT INTO ORDER_ITEM  (ORDERITEM_ID ,COUNT ,ORDER_PRICE ,ITEM_ID ,ORDER_ID ,REVIEW_YN  ) VALUES (4, 1, 1000, 2, 3,false);
